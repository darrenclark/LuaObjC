...
#define LUAOBJC_REGISTRY_OBJECTS		2
#define LUAOBJC_REGISTRY_UNKNOWN_MT		3
#define LUAOBJC_REGISTRY_BENCHMARKS		4
#define LUAOBJC_REGISTRY_SEL_CACHE		5
#define LUAOBJC_REGISTRY_SELECTOR_MT	6
#define LUAOBJC_REGISTRY_STRUCT_MT		7
#define LUAOBJC_REGISTRY_STRUCT_DEF_MT	8
#define LUAOBJC_REGISTRY_LUACLASS_MT	9
#define LUAOBJC_REGISTRY_LUACLASSES		10
